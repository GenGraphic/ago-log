...
import { BillingCycle, PLAN_COMPARISON, PLAN_PRICE, PRO_FEATURES } from '../../constants/plans';
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: insets.bottom + 40 }}>
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
        >
          <Text style={styles.ctaText}>{isLoading ? 'LOADING…' : 'UPGRADE TO PRO'}</Text>
        </TouchableOpacity>

        {/* ── Billing toggle */}
        <View style={styles.billingToggleRow}>
          <TouchableOpacity onPress={() => setBilling(billing === 'yearly' ? 'monthly' : 'yearly')}>
