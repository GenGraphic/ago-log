...
export default function CameraScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      router.replace({ pathname: '/(main)/add-entry/manual', params: { photoUri: photo?.uri } });
    } finally {
      setCapturing(false);
    }
  };
    ...
    <View style={styles.fill}>
      ...
      <View style={styles.overlay} pointerEvents="box-none">
        ...
        <SafeAreaView edges={['top']}>
          <View style={styles.topBar}>
            ...
            <TouchableOpacity style={styles.iconBtn} onPress={toggleFlash}>
              <Feather name={flash === 'on' ? 'zap' : 'zap-off'} size={22} color={flash === 'on' ? tint : '#fff'} />
            </TouchableOpacity>
          </View>
        </SafeAreaView>
        ...
        <View style={styles.frameWrapper} pointerEvents="none">
          <View style={[styles.frameCorner, styles.tl, { borderColor: tint }]} />
          <View style={[styles.frameCorner, styles.tr, { borderColor: tint }]} />
          <View style={[styles.frameCorner, styles.bl, { borderColor: tint }]} />
          <View style={[styles.frameCorner, styles.br, { borderColor: tint }]} />
        </View>
          ...
          <View style={styles.bottomBar}>
            ...
            <TouchableOpacity
              ...
              {capturing
                ...
                : <View style={[styles.shutterInner, { backgroundColor: tint }]} />
              }
            </TouchableOpacity>
