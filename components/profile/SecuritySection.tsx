    ...
    <>
      ...
      <View style={sharedStyles.card}>
        ...
        <View style={styles.infoBox}>
          <Feather name="info" size={14} color="#00F0FF" style={{ marginTop: 1 }} />
          <Text style={styles.infoText}>
            Your account uses military-grade AES-256 encryption to protect your personal
            data and credentials at all times.
          </Text>
        </View>
      </View>
    </>
