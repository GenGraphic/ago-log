  ...
  return (
    <TouchableOpacity
      ...
      <View style={styles.body}>
        ...
        <ThemedText style={styles.desc} numberOfLines={2}>{item.body}</ThemedText>
      </View>
...
const styles = StyleSheet.create({
  ...
  iconBox: { width: 38, height: 38, borderRadius: 10, justifyContent: 'center', alignItems: 'center', flexShrink: 0, marginTop: 13 },
  ...
  meta: { alignItems: 'flex-end', gap: 6, flexShrink: 0, paddingVertical: 14, paddingRight: 14 },
